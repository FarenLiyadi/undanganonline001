  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-[2] container-fluid flex flex-col items-center min-h-screen justify-center gap-4 py-8 text-white">
        <h1 className="font-cormorant text-[24px] md:text-[40px] text-center">
          The Wedding Ceremony Of
        </h1>
        <div className="container px-12 md:px-0">
          <Slider sliderData={sliderData} perPage={perPage} autoplay={false} />
        </div>
        <h2 className="font-gardenia text-[80px] md:text-[130px] leading-none font-light">
          Hizkia & Lysa
        </h2>
        <p className="font-medium font-roboto text-[12px] md:text-base">
          SABTU, 23 03 2024
        </p>
        <div className="container">
          <hr className="w-1/2 h-px mx-auto bg-white md:w-full" />
        </div>
        <p className="font-cormorant text-center text-[11px] md:text-base">
